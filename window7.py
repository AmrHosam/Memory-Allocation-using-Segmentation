...
class Ui_segment_window(object):
    def setupUi(self, segment_window, output_window):
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(320, 80, 162, 51))
        ...
        self.segment_table.setRowCount(4)
    ...
    def retranslateUi(self, segment_window):
        ...
        segment_window.setWindowTitle(_translate("segment_window", "MainWindow"))
        self.label_2.setText(_translate("segment_window", "method of allocation "))
        self.allocation_type.setItemText(0, _translate("segment_window", "First fit "))
        self.allocation_type.setItemText(1, _translate("segment_window", "Best fit"))
        self.allocation_type.setItemText(2, _translate("segment_window", "Worst fit"))
